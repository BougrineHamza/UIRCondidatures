            ...
            <div class="row">
                <div class="col-md-2 p-0 border-right">
                    <ul class="list-unstyled menu_admin pt-3">
                        ...
                        <li><a href="jurys?api_token=@php echo $_GET['api_token']; @endphp"  class="activated"><i class="material-icons">person_outline</i> Jurys</a></li>
                ...
                <div class="col-md-10">
                    <div class="container mt-md-4">
                       <jurys :mes_jurys="{{ $jurys }}" :ecoles="{{$ecoles}}"></jurys>
                    </div>
                </div>
