            ...
            <div class="row">
                <div class="col-md-2 p-0 border-right">
                    <ul class="list-unstyled menu_admin pt-3">
                        ...
                        @if($role == 1)
                        <li><a href="ecoles?api_token=@php echo $_GET['api_token']; @endphp"><i class="material-icons">domain</i> Ecoles</a></li>
                        @endif
                        ...
                        <li><a href="entretiens?api_token=@php echo $_GET['api_token']; @endphp" class="activated"><i class="material-icons">calendar_today</i> Entretiens</a></li>
                        @if($role == 1)
                        <hr />
                ...
                <div class="col-md-10">
                    <div class="container mt-md-4">
                       <entretiens :mes_entretiens="{{ $entretiens }}" :ecoles="{{ $ecoles }}"></entretiens>
                    </div>
                </div>
