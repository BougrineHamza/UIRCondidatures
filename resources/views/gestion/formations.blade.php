            ...
            <div class="row">
                <div class="col-md-2 p-0 border-right">
                    <ul class="list-unstyled menu_admin pt-3">
                        ...
                        @endif
                        <li><a href="formations?api_token=@php echo $_GET['api_token']; @endphp" class="activated"><i class="material-icons">school</i> Formations</a></li>
                ...
                <div class="col-md-10">
                    <div class="container mt-md-4">
                       <formations :mes_formations="{{ $formations }}" :ecoles="{{ $ecoles }}"></formations>
                    </div>
                </div>
