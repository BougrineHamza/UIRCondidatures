            ...
            <div class="row">
                <div class="col-md-2 p-0 border-right">
                    <ul class="list-unstyled menu_admin pt-3">
                        ...
                        <li><a href="candidats?api_token=@php echo $_GET['api_token']; @endphp" class="activated"><i class="material-icons">group</i> Candidats</a></li>
                        @if($role == 1)
                ...
                <div class="col-md-10">
                    <div class="container mt-md-4">
                       <candidats :mes_candidats="{{ $users }}"></candidats>
                    </div>
                </div>
